...
try {
    ...
    $error_message .= "Error fetching agents: " . $e->getMessage() . "<br>";
}
...
<head>
    ...
    <title>System Directory - Apparels Collection</title>
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="directory.php" class="nav-item active">
        ...
        <div class="main-content">
            <div class="top-header">
                <div class="header-left">
                    ...
                    <div class="header-title">System Directory</div>
                </div>
            ...
            <div class="content">
                ...
                <div class="admin-notice">
                    ...
                    <div class="admin-notice-content">
                        <h3>System Data Restricted</h3>
                        <p>This is a read-only directory. Please connect with the <strong>IT Admin</strong> for new user creation, store provisioning, or role modifications.</p>
                    </div>
                </div>

                <div class="directory-tabs">
                    <button class="dir-tab-btn active" id="btn-agents" onclick="switchDirectoryTab('agents')">
                        <span class="material-symbols-outlined">people</span> Active Agents
                    </button>
                    <button class="dir-tab-btn" id="btn-stores" onclick="switchDirectoryTab('stores')">
                        <span class="material-symbols-outlined">storefront</span> Registered Stores
                    </button>
                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($agents as $agent): ?>
                                            <tr class="agent-row">
                                                ...
                                                <td>
                                                    <span class="sys-badge search-badge">@<?php echo htmlspecialchars($agent['username']); ?></span>
                                                </td>
                ...
                <div id="pane-stores" class="tab-pane" style="display: none;">
                    <div class="panel-card" style="overflow: hidden;">
                        <div class="table-header-bar">
                                    ...
                                    <tr class="store-row">
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($store['region_name'])): ?>
                                                <span class="sys-badge sys-badge-alt" style="margin-top: 4px; font-size: 10px;"><?= htmlspecialchars($store['region_name']) ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
    ...
    function switchDirectoryTab(tabName) {
        ...
        document.getElementById('btn-stores').classList.remove('active');
        
        // Hide all panes
        document.getElementById('pane-agents').style.display = 'none';
        document.getElementById('pane-stores').style.display = 'none';
        ...
        if(agentSearch) {
            agentSearch.addEventListener('input', function(e) {
                ...
                agentRows.forEach(row => {
                    ...
                    row.style.display = (id.includes(query) || name.includes(query) || username.includes(query) || phone.includes(query)) ? '' : 'none';
                });
            });
        }

        // Live Filter for Stores
